        ...
        {isLoading && (
          ...
          >
            <motion.div
              ...
              className="w-12 h-12 rounded-full border-4 border-rose-200 border-t-rose-600"
            />
          </motion.div>
        )}
      </AnimatePresence>
      ...
      {showAnimations && (
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-8">
          ...
          <motion.div
            ...
            className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 md:p-8 mb-8 relative"
          >
                  ...
                  <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
                    <div>
                      ...
                      <div className="flex items-center space-x-4">
                        <motion.div
                          whileHover={{ y: -2 }}
                          className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-rose-50 to-pink-50 rounded-2xl border border-rose-100"
                        >
          ...
          >
            {/* Saved Addresses */}
            <motion.div variants={itemVariants} className="lg:col-span-2 col-span-1">
              <div className="bg-white rounded-2xl md:rounded-3xl shadow-sm border border-gray-100 p-4 md:p-6">
                <div className="flex items-center justify-between mb-4 md:mb-6">
                  <div className="flex items-center space-x-3">
                    <motion.div
                      whileHover={{ rotate: 5 }}
                      className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-rose-500 to-pink-600 rounded-xl md:rounded-2xl flex items-center justify-center"
                    >
            ...
            {/* Recent Orders */}
            <motion.div variants={itemVariants} className="lg:col-span-3 col-span-1">
              <div className="bg-white rounded-2xl md:rounded-3xl shadow-sm border border-gray-100 p-4 md:p-6">
                <div className="flex items-center justify-between mb-4 md:mb-6">
                  <div className="flex items-center space-x-3">
                    <motion.div
