            ...
            <div className="flex-1 overflow-y-auto p-6">
              <div className="space-y-6">
                {wishlistItems.map((item) => (
                  <div key={item.id} className="group bg-gradient-to-br from-white to-rose-50/30 p-4 rounded-2xl border border-rose-100 hover:shadow-lg transition-all duration-300">
